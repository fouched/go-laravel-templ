...
func Login() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/login.templ`, Line: 13, Col: 81}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var3))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "\"><div class=\"mb-3\"><label for=\"email\" class=\"form-lable\">Email</label> <input type=\"email\" class=\"form-control\" id=\"email\" name=\"email\" required autocomplete=\"email-new\"></div><div class=\"mb-3\"><label for=\"password\" class=\"form-lable\">Password</label> <input type=\"password\" class=\"form-control\" id=\"password\" name=\"password\" required autocomplete=\"password-new\"></div><div class=\"form-check form-switch\"><input type=\"checkbox\" class=\"form-check-input\" id=\"remember\" name=\"remember\" value=\"remember\"> <label for=\"remember\" class=\"form-check-label\">Remember me</label></div><hr><button type=\"submit\" class=\"btn btn-primary\" onclick=\"validate()\">Login</button><p class=\"mt-2\"><small><a href=\"/users/forgot-password\">Forgot password?</a></small></p></form><div class=\"text-center\"><a href=\"/\" class=\"btn btn-outline-secondary\">Back</a></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
